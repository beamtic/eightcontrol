...
class file_handler {
 ...
 public function simple_delete($file_or_dir) {
 ...
 public function read_file_lines($arguments_arr) {
 ...
 public function count_lines($arguments_arr) {
 ...
 public function write_file($arguments_arr) {
   $default_argument_values_arr = array(
		'path' => 'REQUIRED',
		'content' => '',
 ...
 public function create_directory($arguments_arr) {
	$default_argument_values_arr = array(
		'path' => 'REQUIRED',
		'permissions' => '0775'
    );
 ...
 private function read_file_settings($arg_arr) {
   $read_setting = array();
 ...
 private function handle_error($arguments_arr) {
	$default_argument_values_arr = array(
		'action' => 'REQUIRED',
		'path' => ''
    );
